<div class="login-form">
    <h1> Select Patient for the Result </h1>
  <div class="main-form">
        <div class="login">
            <div class="inset">

 <form action="<?php echo base_url();?>results/add_result" enctype="multipart/form-data" method="post" onsubmit="return validareportandard(this)">
                     <div>
